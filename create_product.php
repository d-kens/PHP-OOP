...
if($_POST){
    ...
    //We used the built-in sha1_file() function to make the file name unique
    ...
    if($product->create()) {
        ...
        // uploadPhoto() method will return anerror message, if any
...
<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post"enctype="multipart/form-data">
    ...
    <table class='table table-hover table-responsive table-bordered'>
        ...
        <tr>
            ...
            <?php
                // Read product categories form the database
                $stmt = $category->read();
